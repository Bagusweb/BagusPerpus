  ...
  <body>
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
          <h2 class="fw-bold text-success"><span class="text-primary">Bagus</span>perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">Bagusperpus</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      ...
      <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
        <div class="card border-info mb-3" style="max-width: 18rem;">
          <div class="card-body">
            <h5 class="card-title">BagusErlangga</h5>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">JL Madrasah Gandul, Cinere</p>
        </div>
        <hr class="text-light mt-3">
        <div class="d-flex justify-content-center gap-4">
          <a href="https://github.com/Bagusweb" class="fs-3"><i class="fa-brands fa-github"></i></a>
          <a href="https://wa.me/6285894493680" class="fs-3"><i class="fa-brands fa-whatsapp"></i></a>
          <a href="https://www.instagram.com/lanzzz.20?igsh=ZmZxOHFtMnFhd212" class="fs-3"><i class="fa-brands fa-instagram"></i></a>
        </div>
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made with ❤️ <a href="" class="text-decoration-none">Bagus Web</a>  2024</p>
        </div>
      </div>
    </footer>
